...
# run AMBF with Surgical Robotics Challenge
...
sleep 5 # ensure that everything is running
python3 /root/surgical_robotics_challenge/scripts/surgical_robotics_challenge/launch_crtk_interface.py &
